...
var Select = React.createClass({
	...
	propTypes: {
		...
		onAdd: React.PropTypes.func, // onChange handler: function(newValue) {}
		onRemove: React.PropTypes.func, // onChange handler: function(oldValue) {}
  ...
  */
   ...
   */
	...
	fireAddEvent: function fireChangeEvent(value) {
        if (this.props.onAdd){
            this.props.onAdd(value.value, value);
        }
    },

    fireRemoveEvent: function fireChangeEvent(value) {
